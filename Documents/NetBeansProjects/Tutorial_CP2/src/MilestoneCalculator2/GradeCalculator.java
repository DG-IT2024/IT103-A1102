    ...
    public GradeCalculator() {
        ...
        calculateButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                float milestone1, milestone2, terminalAssessment;
                

                milestone1 = Float.parseFloat(txtQuiz1.getText());
                milestone2 = Float.parseFloat(txtQuiz2.getText());
                terminalAssessment = Float.parseFloat(txtQuiz3.getText());

                if (milestone1 < 0 || milestone1 > 100
                        || milestone2 < 0 || milestone2 > 100
                        || terminalAssessment < 0 || terminalAssessment > 100) {

                    JOptionPane.showMessageDialog(null, "Please enter values within the valid range (0 to 100).", "Input Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                stud.setQuiz1(milestone1);
                stud.setQuiz2(milestone2);
                stud.setQuiz3(terminalAssessment);
